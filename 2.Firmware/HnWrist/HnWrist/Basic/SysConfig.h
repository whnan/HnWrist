...
/*电池检测*/
#define BAT_DET_Pin PB3     //电压检测
#define BAT_CHG_Pin PA15    //充电检测

/*运动传感器*/
#define IMU_SCL_Pin PB7     //I2C时钟
#define IMU_SDA_Pin PB6     //I2C数据
